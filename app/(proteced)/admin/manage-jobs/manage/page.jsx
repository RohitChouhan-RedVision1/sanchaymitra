...
const DataTableDemo = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            header: "Description",
            cell: ({ row }) => <div className="capitalize w-80">{row.getValue("description")}</div>,
        },
        {
                ...
                return (
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuSeparator />
                            <DropdownMenuItem onClick={() => router.push(`/admin/manage-jobs/edit-job/${blog._id}`)}>
                                Edit
                            </DropdownMenuItem>
    ...
    return (
        <div>
            <div className="flex justify-between">
                ...
                <Link href="/admin/manage-jobs/add-job">
